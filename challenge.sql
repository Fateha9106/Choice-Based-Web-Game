...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2018 at 05:05 PM
...
CREATE TABLE `challenge` (
  ...
  `imgsrc` varchar(400) NOT NULL DEFAULT '#'
...
INSERT INTO `challenge` (`cid`, `day`, `title`, `description`, `option_no`, `option1`, `option2`, `option3`, `result1`, `result2`, `result3`, `next1`, `next2`, `next3`, `cashflow1`, `cashflow2`, `cashflow3`, `weeklychange1`, `weeklychange2`, `weeklychange3`, `jobstrike1`, `jobstrike2`, `jobstrike3`, `imgsrc`) VALUES
(1, 1, 'Get a job', 'Surving as a single person you will need to get a job. There are not much job for fresh graduates with no experience of real life jobs. Yet you need to try your best to choose.', 3, 'Junior programmer. Pays Weekly 3000tk a week.', 'IT Engineer at Govt Job, Pays monthly. 30000 a month. **Requires a lobbing of 120,000 tk.**', '', 'You got a job which will help you learn but pay less. Since you have very little money now. Weekly payment will help you get in feet easily.', 'You cannot choose this since you don\'t have any money to pay the lobbing.', '', '2', '#20', '', 0, 0, 0, 3000, 0, 0, 0, 0, 0, 'images/story-image/jobwanted.jpg'),
(2, 2, 'Find a place to live', 'Since you graduated you cannot stay in the university accomodation any longer and you need a place to crash at night. ', 3, '3 Room Apartment. Nice view and close to work. 10000 tk per month', 'Cozy but close to work 5000 tk per month', 'Share a mess 2000 tk per month', 'With a very little salary this appears to be a luxarious choice which might led you to starving. You have to pay 2500 tk a week.', 'This could be a good option for the time being but might not be the best considering no savings at the end of the month. You have to pay 1250 tk a week.', 'Many of the people in country as such as ours choose to live in very little space to save money', '4', '4', '3', 0, 0, 0, -2500, -1250, -500, 0, 0, 0, 'images/story-image/home.jpg'),
(3, 2, 'A saving plan', 'Since you have chose to go with a mess for living you have created a 1000 taka per month saving account.', 2, 'Ok! Let\'s do this', 'No, I rather spend.', '', 'This might be helpful at the end of the day. Weekly payment 250 tk.', 'Well, now you will have some money in the pocket.', '', '4', '4', '', 0, 0, 0, -250, 0, 0, 0, 0, 0, 'images/story-image/savings.jpg'),
...
(6, 4, 'Daily meal cost', 'Whatever might the earning might be you have to feed yourself.', 2, 'Maid made food. 120 taka day.', 'Street food 80 tk day.', '', 'You chose to have a maid prepare your food. This will cost you 120 taka a day. Healthy but costly. Weekly cost 860 tk.', 'You manage to make the cost 80 taka a day but less healthy. Weekly cost 560 tk.', '', '7', '7', '', 0, 0, 0, -860, -560, 0, 0, 0, 0, 'images/story-image/food.jpg'),
